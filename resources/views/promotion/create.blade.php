                        ...
                        <form method="post" action="{{ route('promotion.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('type') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-name">Loại khuyến mãi <span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group{{ $errors->has('value') ? ' has-danger' : '' }}">
                                            <label class="form-control-label" for="input-value">{{ __('promotion.value') }} <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('days_of_week') ? ' has-danger' : '' }}">
                                            <label class="form-control-label" for="input-name">{{ __('promotion.days_of_week') }} <span class="text-danger">*</span></label>
                                            <div class="form-control-radio">
                                ...
                                <div class="input-daterange datepicker row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-usable_from">{{ __('promotion.usable_from') }} <span class="text-danger">*</span></label>
                                            <input class="form-control bg-white" id="input-usable_from" name="usable_from" readonly type="text" value="{{ now()->format('d/m/Y') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-usable_to">{{ __('promotion.usable_to') }} <span class="text-danger">*</span></label>
                                            <input class="form-control bg-white" id="input-usable_to" name="usable_to" readonly type="text" value="{{ now()->format('d/m/Y') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-control-label">Khung giờ áp dụng từ <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-control-label">Khung giờ áp dụng đến <span class="text-danger">*</span></label>
                                                <select class="form-control" onfocus="if (this.options.length > 8) this.size=5" onblur="this.size=1" onchange="this.size=1; this.blur();" size="1">
                                                    <option value="08:00">08:00</option>
                                                    <option value="08:30">08:30</option>
                                                    <option value="09:00">09:00</option>
