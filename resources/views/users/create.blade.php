...
@section('content')
    @include('layouts.headers.header', ['title' => __('user.create')])
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6">
                                        <div class="form-group{{ $errors->has('username') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="username" id="input-username" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="{{ __('user.username') }}" autofocus>
                                    ...
                                    <div class="col-xl-4 col-lg-6">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="name" id="input-name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('user.name') }}">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="email" name="email" id="input-email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('user.email') }}">
