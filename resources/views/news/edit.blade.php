                        ...
                        <form method="post" action="{{ route('news.update', $news) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="title" id="input-title" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" placeholder="{{ __('news.title') }}" value="{{ old('news.title', $news->title) }}" autofocus>
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success mt-4 px-4">{{ __('news.edit') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
